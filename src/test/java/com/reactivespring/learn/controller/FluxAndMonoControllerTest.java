...
@WebFluxTest //only search for @Controller and @RestController
public class FluxAndMonoControllerTest {

    @Autowired
    //non blocking client,
            // webfluxTest annotation creates the instance of the client
    ...
    public void mono(){
        ...
        Integer expetedValue = new Integer(1);
        ...
        webTestClient.get()
                ...
                .consumeWith((result) -> {
                    assertEquals(expetedValue, result.getResponseBody());
                });
